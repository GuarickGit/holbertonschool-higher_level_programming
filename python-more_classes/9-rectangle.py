...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: Le rectangle ayant la plus grande aire, ou rect_1 si
    ...
    def square(cls, size=0):
        """Crée un nouveau rectangle dont la largeur et la hauteur sont égales.

        Cette méthode de classe permet de créer un rectangle carré.

        Args:
            size (int): Taille des côtés du carré (largeur et hauteur).
                        Par défaut à 0.

        Returns:
            Rectangle: Une nouvelle instance de Rectangle avec largeur
